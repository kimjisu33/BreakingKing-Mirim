...
minibackImg.src="../img/underground/map.png";
...
backgroundImg.src="../img/underground/map.png"; //배경
let charImg=new Image();
let ObstacleImg=new Image();
charImg.src="../img/underground/char_ready.png";
ObstacleImg.src="../img/underground/obs.png"; //장애물
let ObsBreakImg=new Image();
ObsBreakImg.src="../img/underground/obsB.png";
...
function Space(){
  //처음 점프 할 때
      ...
      if(Spacekey==-1){
        ...
        charImg.src="../img/underground/char_flying.png"; 
      ...
      //격파 할 때
        ...
        //좌우 구분
        if(direction=true){
          charImg.src="../img/underground/char_lkick.png"; 
        }
        else {
          charImg.src="../img/underground/char_rkick.png"; 
        } 
        chkBreak();
        setTimeout(() => charImg.src="../img/underground/char_flying.png", 200);
